...
window.alert("Dear User,Our website is still under construction.We are working to make sure that our Comment section is responsive which is from our database and other minor problems.We promise to fix it soon");
console.log('Dear User,Our website is still under construction.We are working to make sure that our Comment section is responsive which is from our database and other minor problems.We promise to fix it soon')